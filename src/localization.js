...
let locales = new LocalizedStrings({
  en:{
    ...
    errorMessage: "Please enter a valid number between 1 and 3,999"
  },
  it: {
    ...
    errorMessage: "Si prega di inserire un numero valido tra 1 e 3.999"
  },
  es: {
    ...
    errorMessage: "Por favor ingrese un número válido entre 1 y 3,999"
  }
});
